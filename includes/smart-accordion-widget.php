...
class Smart_Accordion_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Smart Accordion', 'smart-elementor-accordion' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __( 'Content', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            'text_content',
            [
                'label'   => __( 'Text', 'smart-elementor-accordion' ),
                'type'    => Controls_Manager::WYSIWYG,
                'default' => __( 'Enter your text here...', 'smart-elementor-accordion' ),
                'dynamic' => [ 'active' => true ],
            ]
        );
        ...
        $this->add_control(
            'enable_accordion',
            [
                'label'        => __( 'Enable Accordion', 'smart-elementor-accordion' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __( 'Yes', 'smart-elementor-accordion' ),
                'label_off'    => __( 'No', 'smart-elementor-accordion' ),
                'return_value' => 'yes',
                'default'      => 'no',
            ]
        );
        ...
        $this->add_control(
            'visible_lines',
            [
                'label'     => __( 'Visible Lines', 'smart-elementor-accordion' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Icons & Labels', 'smart-elementor-accordion' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'enable_icons',
            [
                'label'        => __( 'Enable Icons', 'smart-elementor-accordion' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __( 'Yes', 'smart-elementor-accordion' ),
                'label_off'    => __( 'No', 'smart-elementor-accordion' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'open_icon',
            [
                'label' => __( 'Open Icon', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            'close_icon',
            [
                'label' => __( 'Close Icon', 'smart-elementor-accordion' ),
                'type' => Controls_Manager::ICONS,
                'default' => [
                    'value' => 'fas fa-minus',
                    'library' => 'fa-solid',
        ...
        $this->add_control(
            'icon_size',
            [
                'label'     => __( 'Icon Size', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            'icon_color',
            [
                'label'     => __( 'Icon Color', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            'open_text',
            [
                'label' => __( 'Open Text', 'smart-elementor-accordion' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Read More', 'smart-elementor-accordion' ),
            ]
        );
        ...
        $this->add_control(
            'close_text',
            [
                'label' => __( 'Close Text', 'smart-elementor-accordion' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Read Less', 'smart-elementor-accordion' ),
            ]
        );
        ...
        $this->start_controls_section(
            'style_section',
            [
                'label' => __( 'Style', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            'content_bg_color',
            [
                'label'     => __( 'Content Background Color', 'smart-elementor-accordion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'content_padding',
            [
                'label' => __( 'Content Padding', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Content Border Radius', 'smart-elementor-accordion' ),
                'type'  => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        $this->add_control(
            'text_color',
            [
                'label'     => __( 'Text Color', 'smart-elementor-accordion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __( 'Typography', 'smart-elementor-accordion' ),
                'selector' => '{{WRAPPER}} .accordion-content, {{WRAPPER}} .normal-text',
            ]
        );
        ...
        $this->add_control(
            'text_alignment',
            [
                'label'     => __( 'Text Alignment', 'smart-elementor-accordion' ),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'left'   => [
                        'title' => __( 'Left', 'smart-elementor-accordion' ),
                        'icon'  => 'fa fa-align-left',
                    ],
                    'center' => [
                        'title' => __( 'Center', 'smart-elementor-accordion' ),
                        'icon'  => 'fa fa-align-center',
                    ],
                    'right'  => [
                        'title' => __( 'Right', 'smart-elementor-accordion' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Button Style', 'smart-elementor-accordion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'button_text_color',
            [
                'label'     => __( 'Button Text Color', 'smart-elementor-accordion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_bg_color',
            [
                'label'     => __( 'Button Background Color', 'smart-elementor-accordion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
         ...
         $this->add_control(
            ...
            [
                'label'     => __( 'Button Hover Background Color', 'smart-elementor-accordion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
       ...
       // Button Border Radius
        $this->add_control(
            ...
            [
                'label' => __( 'Button Border Radius', 'smart-elementor-accordion' ),
                'type'  => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
       ...
       // Button Padding
        $this->add_control(
            'button_padding',
            [
                'label' => __( 'Button Padding', 'smart-elementor-accordion' ),
                'type'  => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __( 'Button Typography', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            'button_alignment',
            [
                'label'   => __( 'Button Alignment', 'smart-elementor-accordion' ),
                'type'    => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => __( 'Left', 'smart-elementor-accordion' ),
        ...
        $this->add_control(
            'button_margin',
            [
                'label' => __( 'Button Margin', 'smart-elementor-accordion' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
